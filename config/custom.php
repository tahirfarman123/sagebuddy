...
return [
    'shopify_api_key' => env('SHOPIFY_API_KEY', '1705c24d234121aced96001cfcbbc4ca'),
    'shopify_api_secret' => env('SHOPIFY_API_SECRET', 'c49e588ccdc6b6e33c64965048709398'),
    'shopify_api_version' => '2023-10',
    'fulfillment_service_name' => 'App Fulifllment Service',
    'select_store' => '',
    'stripe_api_key' => env('STRIPE_KEY', ''),
    'stripe_api_secret' => env('STRIPE_SECRET', ''),
    'app_embedded' => env('APP_EMBEDDED', true),
    ...
    'default_permissions' => [
        ...
        'write-stores', 'read-stores',
        'write-setting', 'read-setting', 
        'wirte-courier', 'sync-order'
    ],
    'table_indexes' => [
        'orders_table_indexes' => [
            'store_id' => 'int', 'ship_province' => 'string', 'ship_country' => 'string',
