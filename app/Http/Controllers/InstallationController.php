            ...
            if ($validRequest) {
                ...
                if ($shop) {
                    ...
                    if ($storeDetails !== null && $storeDetails !== false) {
                        ...
                        // dd('helo');
                        $scop = "read_orders, write_orders, write_fulfillments, write_customers, read_products, write_products, read_third_party_fulfillment_orders, write_third_party_fulfillment_orders, write_assigned_fulfillment_orders, read_assigned_fulfillment_orders,  read_merchant_managed_fulfillment_orders, write_merchant_managed_fulfillment_orders";
                        $endpoint = 'https://' . $request->shop .
                            '/admin/oauth/authorize?client_id=' . $this->api_key .
                            '&scope=' . $scop .
                            '&redirect_uri=' . config('app.ngrok_url') . '/shopify/auth/redirect';
    ...
    private function requestAccessTokenFromShopifyForThisStore($shop, $code)
    {
        try {
            ...
            $requestBody = json_encode([
                ...
                'client_secret' => 'c49e588ccdc6b6e33c64965048709398',
                'code' => $code
            ]);
