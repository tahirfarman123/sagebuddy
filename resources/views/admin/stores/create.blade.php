        ...
        <div class="card-body">
          ...
          <form method="POST" action="{{route('stores.store')}}">
            ...
            <div class="row mb-3 mt-4">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="myshopify_domain" value="{{old('myshopify_domain')}}"
                  required>
            ...
            {{-- <div class="row mb-3 mt-4">
              ...
              <div class="col-sm-10">
                <input type="password" class="form-control" name="api_secret_key" value="{{old('api_secret_key')}}"
                  required>
